...
bio_tags = [
    ...
    ("starting", "O"), 
    ("at", "O"), 
    ("Park", "B-start_location"),
]

# Initialize tracker
tracker = Tracker()

# Update slots with new input
tracker.update(bio_tags)

# Check slot state
print("Filled Slots:", tracker.slots)  # Display filled slots
print("Missing Slots:", tracker.missing_slots())  # Display missing slots
